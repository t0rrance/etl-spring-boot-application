...
insert into travels values (1, 't1', 10,0,1001, '2019-01-01',  '2019-01-01');
insert into travels values (2, 't2', 10,0,1002, '2019-01-01',  '2019-01-01');
insert into travels values (3, 't3', 10,0,1003, '2019-01-01',  '2019-01-01');
-- rollback delete table travels

-- changeset mk:insert-clients
insert into clients values (1, 'first1','lastName1', 123456789 , 'street 01');
insert into clients values (2, 'first2','lastName2', 123456789 , 'street 02');
insert into clients values (3, 'first3','lastName3', 123456789 , 'street 03');
